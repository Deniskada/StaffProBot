<div class="card">
    <div class="card-header">
        <h1 class="card-title">Редактировать объект</h1>
    </div>
    <div class="card-body">
        <form action="/facilities/<?= $facility->id ?>/update" method="POST">
            <?= $this->csrf() ?>
            
            <div class="mb-3">
                <label class="form-label">Название</label>
                <input type="text" name="name" class="form-control" required
                       value="<?= $this->escape($this->old('name', $facility->name)) ?>">
            ...
            <div class="mb-3">
                ...
                ><?= $this->escape($this->old('address', $facility->address)) ?></textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="city" class="form-control" required
                       value="<?= $this->escape($this->old('city', $facility->city)) ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="coordinates" class="form-control"
                       value="<?= $this->escape($this->old('coordinates', $facility->coordinates)) ?>"
            ...
            <div class="mb-3">
                ...
                <select name="status" class="form-select" required>
                    <option value="active" <?= $this->old('status', $facility->status) === 'active' ? 'selected' : '' ?>>
                        Активен
                    </option>
                    <option value="inactive" <?= $this->old('status', $facility->status) === 'inactive' ? 'selected' : '' ?>>
                        Неактивен
                    </option>
                </select>
